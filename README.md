Welcome to your Tiger Pajamas Web Site!
...
To use the cool custom dividers, put one of the following in your markdown:
```
<hr class="divider-1" />
<hr class="divider-2" />
<hr class="divider-3" />
...
`chickadee.md` contains examples of the custom dividers, as well as buttons:
```
